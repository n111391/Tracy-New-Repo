...
//		TODO Auto-generated constructor stub
	...
	public String getElementText(String accessType, String accessName) {
		...
		element = selectelementbytype.wait.until(ExpectedConditions
	...
	public void isOptionFromRadioButtonGroupSelected(String accessType, String by, String option, String accessName,
		...
		SelectElementByType selectelementbytype = new SelectElementByType(driver);
		List<WebElement> radioButtonGroup = selectelementbytype.wait.until(ExpectedConditions
	...
	public void isOptionFromDropdownSelected(String accessType, String by, String option, String accessName,
		...
		WebElement dropdown = selectelementbytype.wait.until(ExpectedConditions
				.presenceOfElementLocated(selectelementbytype.getelementbytype(accessType, accessName)));
