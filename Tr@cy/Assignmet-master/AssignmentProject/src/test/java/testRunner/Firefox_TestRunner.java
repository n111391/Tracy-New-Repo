...
@CucumberOptions(plugin = { "com.cucumber.listener.ExtentCucumberFormatter:", "json:target/cucumber-reports/Cucumber.json" }, features = { "features/test.feature" }, glue = {
"steps" }, dryRun = false , monochrome = true)// tags = "@naresh")

public class Firefox_TestRunner {

	static {
		DefinedSteps.browser = "FIREFOX";
	}
	...
	public static void setup() throws IOException {
		...
		util.deleteSheet();
		String reportPath = res.readConfig("FirefoxReport") + timeStamp + ".html";
